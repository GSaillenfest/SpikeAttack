...
public class ScorePanelAnimationHandler : MonoBehaviour
{
    ...
    VertexGradient orangeGradient = new VertexGradient(
       new Color32(255, 165, 0, 255),  // Orange clair en haut � gauche
       new Color32(255, 140, 0, 255),  // Orange moyen en haut � droite
       new Color32(255, 69, 0, 255),   // Orange fonc� en bas � gauche
       new Color32(255, 69, 0, 255)// Orange fonc� en bas � droite
       );
    VertexGradient blueGradient = new VertexGradient(
            new Color32(135, 206, 250, 255), // Bleu clair en haut � gauche
            new Color32(135, 206, 235, 255), // Bleu ciel en haut � droite
            new Color32(70, 130, 180, 255),  // Bleu acier en bas � gauche
            new Color32(70, 130, 160, 255)   // Bleu acier fonc� en bas � droite
        );
